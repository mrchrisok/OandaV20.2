...
namespace OkonkwoOandaV20.TradeLibrary.REST
{
   ...
   public partial class Rest20
   {
      ...
      public static async Task<List<CandlestickPlus>> GetCandlesAsync(CandlesParameters parameters)
      {
         string uri = ServerUri(Server.Account) + "instruments/" + parameters.instrument + "/candles";
         var requestParams = ConvertToDictionary(parameters);

         CandlesResponse response = await MakeRequestAsync<CandlesResponse>(uri, "GET", requestParams);
   ...
   public class CandlesParameters : InstrumentParameters
   {
      /// <summary>
