...
namespace OkonkwoOandaV20.TradeLibrary.REST
{
   ...
   public partial class Rest20
   {
      ...
      public virtual async Task<InstrumentPositionBookResponse> GetInstrumentPositionBookAsync(InstrumentPositionBookParameters parameters , CancellationToken cancellation = default)
      {
