...
namespace OkonkwoOandaV20.TradeLibrary.REST
{
   ...
   public partial class Rest20
   {
	  ...
	  public static async Task<List<CandlestickPlus>> GetPricingInstrumentCandlesAsync(string accountID, string instrument, PricingInstrumentCandlesParameters parameters)
	  {
		 var request = new Request()
		 {
			Uri = $"{ServerUri(EServer.Account)}accounts/{accountID}/instruments/{instrument}/candles",
			Method = "GET",
			Parameters = parameters
		 };

		 var response = await MakeRequestAsync<PricingInstrumentCandlesResponse, PricingInstrumentCandlesErrorResponse>(request);
	  ...
	  public class PricingInstrumentCandlesParameters : Parameters
	  {
		 /// <summary>
   ...
   /// <summary>
   /// The GET success response received from Pricing instruments/instrument/candles
   /// </summary>
   public class PricingInstrumentCandlesResponse : Response
   {
	  /// <summary>
   ...
   /// </summary>
   public class PricingInstrumentCandlesErrorResponse : ErrorResponse
   {
   }
}